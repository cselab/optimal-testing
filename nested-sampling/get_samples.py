...
def Uniform_Samples(days,samples):
    ...
    p_min = [0.8, 0.2, 0.02, 1.0, 1.0, 1.0   ,1000,1000,1000,1000,1000,1000 ]
    p_max = [1.8, 1.0, 1.00, 6.0, 6.0, 1.4   ,1000,1000,1000,1000,1000,1000 ]

    #p_mle = np.load("mle.npy")
    for i in range (12):
          p_min.append(0.0 )
          p_max.append(30.0)
          #p_min.append(p_mle[6+i])
          #p_max.append(p_mle[6+i])
